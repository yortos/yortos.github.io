...
After grad school, I was a part of the **Spotify Notifications team for two years, collaborating with User Research, Product, and Engineering to enhance user engagement through timely and valuable notifications**. After that, I was part of Spotify the Finance team for a year, playing a key role in **developing the user growth forecast**. This forecast informed resource allocation decisions by the CFO as well as the quarterly shareholder guidance. I presented the math and engineering behind this work at the [Rev2 Data Science conference in NYC](youtube.com/watch?v=tkmWXM0egqg).
